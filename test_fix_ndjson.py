...
class TestNDJSONRecovery:
    ...
    def test_valid_ndjson_unchanged(self):
        ...
        try:
            objects_recovered, lines_fixed, total_lines = fix_ndjson_file(input_file, output_file)
    ...
    def test_malformed_json_handling(self):
        ...
        try:
            ...
            assert objects_recovered == 3
            assert lines_fixed == 2  # Both the malformed line and concatenated line are "fixed"
            assert total_lines == 3
    ...
    def test_large_scale_simulation(self):
        ...
        # 98 normal lines
        for i in range(98):
            content.append(f'{{"sessionguid": "normal-{i}", "sessiontype": "Messaging", "data": "content"}}')
        
        # 2 concatenated lines (simulating 0.1% error rate)
        content.append('{"sessionguid": "concat-1", "sessiontype": "Telephony"}{"sessionguid": "concat-2", "sessiontype": "Email"}')
        content.append('{"sessionguid": "concat-3", "sessiontype": "Social"}{"sessionguid": "concat-4", "sessiontype": "Report"}')
        ...
        try:
            ...
            success_rate = (objects_recovered / (lines_fixed * 2 + total_lines - lines_fixed)) * 100
